...
var RegionSelect = function (_Component) {
	...
	function RegionSelect(props) {
		...
		var src = _this.props.children.props.src;
	...
	_createClass(RegionSelect, [{
		...
		value: function getClientPos(e) {
			...
			var _document$getElements = document.getElementsByClassName('image-container'),
			    ...
			    _document$getElements3 = _document$getElements2[0],
			    scrollLeft = _document$getElements3.scrollLeft,
			    scrollTop = _document$getElements3.scrollTop,
			    offsetLeft = _document$getElements3.offsetLeft,
			    offsetTop = _document$getElements3.offsetTop;
		...
		value: function onComponentMouseTouchDown(event) {
			...
			var _document$getElements4 = document.getElementsByClassName('image-container'),
			    _document$getElements5 = _slicedToArray(_document$getElements4, 1),
			    container = _document$getElements5[0];
		...
		value: function getElementOffset(el) {
			...
			var _document$getElements6 = document.getElementsByClassName('image-container'),
			    _document$getElements7 = _slicedToArray(_document$getElements6, 1),
			    container = _document$getElements7[0];
		...
		key: 'onImageLoad',
		value: function onImageLoad(_ref) {
			var img = _ref.target;
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'image-container', style: _style2.default.ContainerStyle,
						onTouchStart: this.onComponentMouseTouchDown,
						onMouseDown: this.onComponentMouseTouchDown },
					this.renderDebug(),
					regions.map(this.renderRect.bind(this)),
					_react2.default.createElement('img', { src: this.imageSrc, style: imageStyle, onLoad: this.onImageLoad })
				)
			);
		}
	}]);
