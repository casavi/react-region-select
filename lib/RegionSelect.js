...
var RegionSelect = function (_Component) {
	...
	function RegionSelect(props) {
		...
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RegionSelect).call(this, props));
	...
	_createClass(RegionSelect, [{
		...
		value: function onDocMouseTouchMove(event) {
			...
			this.props.onChange([].concat(_toConsumableArray(this.props.regions.slice(0, index)), [Object.assign({}, updatingRegion, rect)], _toConsumableArray(this.props.regions.slice(index + 1))));
		}
	}, {
		...
		value: function onDocMouseTouchEnd() {
			if (this.isChanging) {
				...
				this.props.onChange([].concat(_toConsumableArray(this.props.regions.slice(0, index)), [Object.assign({}, updatingRegion, changes)], _toConsumableArray(this.props.regions.slice(index + 1))));
			}
		}
	}, {
...
var Region = function (_Component2) {
	_inherits(Region, _Component2);

	function Region(props) {
		_classCallCheck(this, Region);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(Region).call(this, props));
	}
	...
	_createClass(Region, [{
		...
		value: function renderHandles() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement('div', { 'data-dir': 'se', style: style.RegionHandleSE }),
				_react2.default.createElement('div', { 'data-dir': 'sw', style: style.RegionHandleSW }),
				_react2.default.createElement('div', { 'data-dir': 'nw', style: style.RegionHandleNW }),
				_react2.default.createElement('div', { 'data-dir': 'ne', style: style.RegionHandleNE })
			);
		}
	}, {
		key: 'render',
